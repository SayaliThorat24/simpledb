...
public class HeapPage implements Page {
	...
	public Iterator<Tuple> iterator() {
	    return new Iterator<Tuple>() {
	      ...
	      int maxIndex = entryCount();
	      int currentIndex = getUsedIndex(0, maxIndex);
	      ...
	      @Override
	      public Tuple next() {
	  		Tuple tuple = getTuple(currentIndex);
	  		currentIndex = getUsedIndex(currentIndex+1, maxIndex);
	  		return tuple;
	      }
	...
	public int getUsedIndex(int currentIndex, int maxIndex){
		while((currentIndex < maxIndex) && (getTuple(currentIndex)== null))
			currentIndex++;
		return currentIndex;
	}
	...
	public Tuple getTuple(int entryID) {
		...
		if(location != 0){
			DataInputStream in = new DataInputStream(new ByteArrayInputStream(data, location, data.length));
